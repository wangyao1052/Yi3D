...
#ifndef WY3D_SKETCH_ARC3D_H
#define WY3D_SKETCH_ARC3D_H
...
class WY3D_EXPORT SketchArc3D : public wy3d::SketchCurve3D
{
    WYDB_DECLARE_MEMBERS(SketchArc3D, wy3d::SketchArc3D, wy3d::SketchCurve3D)
...
public:
    ...
    wy::Vector3 getMiddlePoint() const;
