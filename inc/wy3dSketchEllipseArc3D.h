...
#ifndef WY3D_SKETCH_ELLIPSE_ARC3D_H
#define WY3D_SKETCH_ELLIPSE_ARC3D_H
...
// 3D草图椭圆弧:起止角为极角(自长轴方向逆时针,内部存弧度)
class WY3D_EXPORT SketchEllipseArc3D : public wy3d::SketchCurve3D
{
    WYDB_DECLARE_MEMBERS(SketchEllipseArc3D, wy3d::SketchEllipseArc3D, wy3d::SketchCurve3D)
...
public:
    static wy::ErrorStatus create(
        ...
        double startAngle,
        double endAngle,
        SketchEllipseArc3D*& pOutSketchEllipseArc3D);
...
#endif // WY3D_SKETCH_ELLIPSE_ARC3D_H
