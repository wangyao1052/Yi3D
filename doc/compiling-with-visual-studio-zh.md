...
从 [https://github.com/wangyao1052/Yi3D-LibBundles-Windows/releases/tag/v1.0.2](https://github.com/wangyao1052/Yi3D-LibBundles-Windows/releases/tag/v1.0.2) 下载 `Yi3D-LibBundles-1.0.2.zip`，解压到 `Yi3D/3rdParty/bundles/`。
