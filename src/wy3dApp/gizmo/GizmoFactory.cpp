...
GizmoFactory::GizmoFactory()
{
    ...
    REGISTER_CREATOR(wy3d::Solidify, NullGizmoCreator);
    REGISTER_CREATOR(wy3d::NonParametricSolid, NullGizmoCreator);
    ...
    REGISTER_CREATOR(wy3d::NonParametricSheet, NullGizmoCreator);
